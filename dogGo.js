...
function buildCart(dogStr) {
  ...
  text.innerHTML = '<h1>' + dog.name + '</h1><table><tr><td id="picture' + dog.name + date + '"></td><td><h3>' + dog.description + '</h3><h3>' + dayoOfWeek[date.getDay()] + ", " + monthOfYear[date.getMonth()] + " " + date.getDate() + '</h3><h1 id="price' + dog.name + date + '">$' + dog.price + '</h1></td></tr></table><div id="button' + dog.name + date + '"></div>';
